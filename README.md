# tachys 0.2.18, lazy hydration behind a feature

Backport of [leptos-rs/leptos#4438](https://github.com/leptos-rs/leptos/pull/4438) onto the published `tachys` 0.2.18 crate.
...
`leptos` 0.8.20 requires `tachys ^0.2.16`, which is why this branch tracks 0.2.18 rather than the 0.2.15 the backport first landed on.

Usage:

    [patch.crates-io]
    tachys = { git = "https://github.com/librejustice/tachys", rev = "dab2a4e07cf4c7534a575e44413b227c1dd19495" }
